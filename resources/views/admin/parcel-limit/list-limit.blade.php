                    ...
                    <tbody id="parcel-data">
                        ...
                        @foreach($limits as $limit)
                            <tr id="tr-{{$limit->id}}">
                                ...
                                <td> {{ $limit->cityName ? $limit->cityName->name : '' }} </td>
                                <td> {{ $limit->limit }} </td>
                                <td> {{ $limit->userName ? $limit->userName->name : '' }} </td>
                                <td>
                                    <a href="{{route('editParcelLimit', $limit->id)}}"><button class="btn waves-effect waves-light btn-primary"><i class="fa fa-edit"></i>Edit</button></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
