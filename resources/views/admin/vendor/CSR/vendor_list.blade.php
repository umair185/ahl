                    ...
                    <tbody>
                        @foreach($currentlyAssignedVendors as $key => $vendor)
                            <tr>
                                ...
                                @if($vendor->csr_datentime == NULL)
                                <td></td>
                                @else
                                <td>{{date('d M Y h:i a', strtoTime($vendor->csr_datentime))}}</td>
                                @endif
                                <td>{{$vendor->csrAssignedBy ? $vendor->csrAssignedBy->name : ''}}</td>
