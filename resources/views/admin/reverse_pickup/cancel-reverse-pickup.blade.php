        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>Cancelled Reverse Pickup Parcels List</h5>
                            ...
                            <tbody id="parcel-data">
                                ...
                                @foreach($orders as $order)
                                    <tr id="tr-{{$order->id}}">
                                        ...
                                        <td><a target="_blank" href="{{route('parcelDetail', $order->id)}}"><button class="btn waves-effect waves-light btn-primary"><i class="fa fa-arrow-circle-o-right"></i>Detail</button></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
