        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>Reverse Pickup Parcels List</h5>
                            ...
                            <tbody id="parcel-data">
                                ...
                                @foreach($orders as $order)
                                    <tr id="tr-{{$order->id}}">
                                        ...
                                        <td>
                                            <form method="POST" action="{{route('printParcelQR')}}">
                                                @csrf
                                                <input type="hidden" name="parcel_id" value="{{$order->id}}">
                                                <button type="submit" target="_blank" class="btn waves-effect waves-light btn-primary"><i class="fa fa-print"></i>Print</button>
                                            </form>
                                        </td>
                                        <td>
                                            <a target="_blank" href="{{route('ReversePickupRemarks', $order->id)}}"><button class="btn waves-effect waves-light btn-primary"><i class="fa fa-edit"></i>Remarks</button>
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
