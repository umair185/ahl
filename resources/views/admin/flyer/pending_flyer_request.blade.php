                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{date('d M Y h:m a', strtoTime($flyer_request->created_at))}}</td>
                            <td>
                            ...
                            <td>
                                <a href="{{route('flyerRequestStatusChange', $flyer_request->id)}}"><button class="btn waves-effect waves-light btn-primary"><i class="fa fa-arrow-circle-o-right"></i>Accept</button></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
