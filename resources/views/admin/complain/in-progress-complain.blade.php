                    ...
                    <tbody id="parcel-data">
                        ...
                        @foreach($complains as $complain)
                            <tr id="tr-{{$complain->id}}">
                                ...
                                <td>
                                    <a href="{{route('saveResolvedComplain', $complain->id)}}"><button class="btn waves-effect waves-light btn-primary"><i class="fa fa-arrow-circle-o-right"></i>Mark as Resolved</button></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
