                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route('assignRider', $parcelLists->id)}}"><button class="btn waves-effect waves-light btn-success"><i class="fa fa-arrow-circle-o-right"></i>Assign Rider</button></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
