            ...
            <div class="table-responsive" >
                <table class="table table-hover" id="riders_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <?php
                                $parcel_status = 'Un-Attempted';
                                if(($parcel->trip_status_id == 4) && ($parcel->status == 1))
                                {
                                    $parcel_status = 'Delivered';
                                }
                                elseif(($parcel->trip_status_id == 6) && ($parcel->status == 0))
                                {
                                    $parcel_status = 'Re-Attempt';
                                }
                       ...
                       @endforeach
                       <tr>
                            <th colspan="8" style="font-weight: bold; text-align: right">Total</th>
