                            ...
                            <tbody id="parcel-data">
                                ...
                                @foreach($orders as $order)
                                    <tr id="tr-{{$order->id}}">
                                        ...
                                        <td> {{ $order->scanOrder ? $order->scanOrder->scanBySupervisor->name : '' }} </td>
                                        ...
                                        <td>
                                            <a href="{{route('moveToWarehouse', $order->id)}}"><button class="btn waves-effect waves-light btn-primary">Move to AHL Warehouse</button>
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
