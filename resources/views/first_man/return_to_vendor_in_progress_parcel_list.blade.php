...
<div class="page-body">
    <div class="card">
        <button id="selected_parcel_reattempt" class="btn waves-effect waves-light btn-primary"><i class="fa fa-arrow-circle-o-right"></i>Bulk Return to Vendor</button>
        <div class="card-header">
            <h5>Return to Vendor In-Progress Parcels List</h5>
            <form method="get">
                <div class="row">
                ...
                <table class="table table-hover" id="example">
                    ...
                    <tbody>
                        ...
                        <tr id="tr-{{$parcel->id }}">
                            ...
                            <td><a href="{{route('returnToVendorUpdate', $parcel->id)}}"><button class="btn waves-effect waves-light btn-primary"><i class="fa fa-arrow-circle-o-right"></i>Return to Vendor</button></a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
...
$(function () {
    ...
    $("#selected_parcel_reattempt").click(function () {
        ...
        if (checkedArray.length == 0) {
            alert('please select some paracel to mark return to vendor');
        } else {
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: '/bulk-return-to-vendor',
                type: 'POST',
