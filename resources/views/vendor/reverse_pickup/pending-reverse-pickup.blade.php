                            ...
                            <tbody id="parcel-data">
                                ...
                                @foreach($orders as $order)
                                    <tr id="tr-{{$order->id}}">
                                        ...
                                        <td>
                                            <a href="{{route('cancelReversePickupParcel', $order->id)}}" class="btn waves-effect waves-light btn-primary" style="color: white"><i class="fa fa-arrow-circle-o-right"></i>Cancel By Vendor</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
